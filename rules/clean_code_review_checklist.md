...
- [ ] **No Javadoc**: Except for @author and @since tag, we dont want Javadoc comment.
...
- [ ] **Line Length**: Are lines kept to a reasonable length (e.g., under 130 characters) to prevent horizontal scrolling?
